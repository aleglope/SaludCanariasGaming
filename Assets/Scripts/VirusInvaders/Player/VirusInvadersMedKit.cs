...
public class VirusInvadersMedKit : MonoBehaviour
{
    ...
    void ConfigurarComponentes()
    {
        ...
        {
            // If MedKit tag doesn't exist, use default
        ...
        transform.localScale = Vector3.one * 0.15f; // Small pill size
    ...
    {
        // Create a basic red cross sprite as fallback
    ...
    IEnumerator AnimacionRecogida()
    {
        ...
        // Pickup effect - scale up and fade out
        float duracion = 0.5f;
        float tiempo = 0f;
    ...
    {
        // Wait to confirm it's actually off-screen
