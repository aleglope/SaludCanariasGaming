...
{
    [Header("VirusInvaders - MedKit Spawner Configuration")]
    public bool activarSpawner = true;
    public float tiempoEntreSpawns = 60f; // Every 1 minute
    public float variacionTiempo = 10f; // ±10 seconds variation
    
    [Header("VirusInvaders - Spawn Area")]
    public float areaSpawnAncho = 15f;
    public float alturaSpawn = 8f;
    public Vector3 centroSpawn = Vector3.zero;
    
    [Header("VirusInvaders - MedKit Properties")]
    public float cantidadCuracionBase = 30f;
    public float variacionCuracion = 10f; // ±10 HP variation
    public float velocidadCaidaBase = 2f;
    public float variacionVelocidad = 0.5f;
    
    [Header("VirusInvaders - Probability")]
    public float probabilidadSpawn = 75f; // 75% chance
    
    [Header("VirusInvaders - Player Health Requirements")]
    public bool soloSiJugadorHerido = true;
    public float umbralVidaBaja = 50f; // Only appear if health < 50%
    ...
    void ConfigurarAreaSpawn()
    {
        ...
        if (camara != null)
        {
            ...
            areaSpawnAncho = anchoCamara * 0.8f; // 80% of screen width
    ...
    void ConfigurarAreaSpawnPorCamara()
    {
        ...
        areaSpawnAncho = anchoVision * 0.8f; // 80% of visible width
